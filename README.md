...
3.  **추론적 온톨로지(Inferential Ontology):** 별도의 데이터베이스 없이도 AI가 본문의 핵심 개념을 엔티티(Entity)와 관계(Relation) 단위로 해체하여 분석하는 **'최소한의 온톨로지 빌딩'** 로직이 탑재되어 있습니다. 이는 `sermon-research`, `bible-study-generator`, `devotional-generator` 등 핵심 주해 및 심층 묵상 스킬의 사유 체계를 지탱합니다.
